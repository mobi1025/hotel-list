...
export const MOCK_HOTEL_PRICES_DATA = [
  {
    id: 1,
    price: 164,
...
export const MOCK_HOTEL_PRICES_DATA_USD = [
  {
    id: 1,
    price: 164,
    competitors: { Traveloka: 190, Expedia: 163 },
...
export const MOCK_LOCATIONS = [
  {
    ...
    osm_type: 'node',
    osm_id: 2327217291,
    boundingbox: ['35.6850858', '35.6851858', '139.6909107', '139.6910107'],
    lat: '35.6851358',
    lon: '139.6909607',
    display_name:
      'Park Hyatt Tokyo, Koshu-kaido Avenue, Nishi-Shinjuku 3-chome, Shinjuku, Tokyo, 163-1423, Japan',
    place_rank: 30,
    category: 'tourism',
    type: 'hotel',
    importance: 0.5058710828992581,
    icon: 'https://nominatim.openstreetmap.org/ui/mapicons/accommodation_hotel2.p.20.png',
  },
];
